...
const CLASS_DEFS = {
	Barbarian: {
		source: "PHB", hitDie: "d12",
		saves: ["str", "con"],
		armorProfs: ["Light armor", "Medium armor", "Shields"],
		weaponProfs: ["Simple weapons", "Martial weapons"],
		skillCount: 2, skillChoices: ["animal handling", "athletics", "intimidation", "nature", "perception", "survival"],
		casterType: null,
	},
	Bard: {
		source: "PHB", hitDie: "d8",
		saves: ["dex", "cha"],
		...
		skillCount: 3, skillChoices: ALL_SKILLS, // Bard can choose any 3
		casterType: "full", castingAbility: "cha",
		cantripsKnown: 2, spellsKnown: 4, maxSpellLevel: 1,
	},
	Cleric: {
		source: "PHB", hitDie: "d8",
		saves: ["wis", "cha"],
		...
		skillCount: 2, skillChoices: ["history", "insight", "medicine", "persuasion", "religion"],
		casterType: "full", castingAbility: "wis",
		cantripsKnown: 3, preparedCaster: true, maxSpellLevel: 1,
	},
	Druid: {
		source: "PHB", hitDie: "d8",
		saves: ["int", "wis"],
		...
		skillCount: 2, skillChoices: ["arcana", "animal handling", "insight", "medicine", "nature", "perception", "religion", "survival"],
		casterType: "full", castingAbility: "wis",
		cantripsKnown: 2, preparedCaster: true, maxSpellLevel: 1,
	},
	Fighter: {
		source: "PHB", hitDie: "d10",
		saves: ["str", "con"],
		armorProfs: ["Light armor", "Medium armor", "Heavy armor", "Shields"],
		weaponProfs: ["Simple weapons", "Martial weapons"],
		skillCount: 2, skillChoices: ["acrobatics", "animal handling", "athletics", "history", "insight", "intimidation", "perception", "survival"],
		casterType: null,
	},
	Monk: {
		source: "PHB", hitDie: "d8",
		...
		skillCount: 2, skillChoices: ["acrobatics", "athletics", "history", "insight", "religion", "stealth"],
		casterType: null,
	},
	Paladin: {
		source: "PHB", hitDie: "d10",
		...
		armorProfs: ["Light armor", "Medium armor", "Heavy armor", "Shields"],
		weaponProfs: ["Simple weapons", "Martial weapons"],
		skillCount: 2, skillChoices: ["athletics", "insight", "intimidation", "medicine", "persuasion", "religion"],
	...
	Ranger: {
		...
		armorProfs: ["Light armor", "Medium armor", "Shields"],
		weaponProfs: ["Simple weapons", "Martial weapons"],
		skillCount: 3, skillChoices: ["animal handling", "athletics", "insight", "investigation", "nature", "perception", "stealth", "survival"],
	...
	Rogue: {
		...
		skillCount: 4, skillChoices: ["acrobatics", "athletics", "deception", "insight", "intimidation", "investigation", "perception", "performance", "persuasion", "sleight of hand", "stealth"],
		casterType: null,
	},
	Sorcerer: {
		source: "PHB", hitDie: "d6",
		saves: ["con", "cha"],
		armorProfs: [],
		weaponProfs: ["Daggers", "Darts", "Slings", "Quarterstaffs", "Light crossbows"],
		skillCount: 2, skillChoices: ["arcana", "deception", "insight", "intimidation", "persuasion", "religion"],
		casterType: "full", castingAbility: "cha",
		cantripsKnown: 4, spellsKnown: 2, maxSpellLevel: 1,
	},
	Warlock: {
		source: "PHB", hitDie: "d8",
		saves: ["wis", "cha"],
		armorProfs: ["Light armor"],
		weaponProfs: ["Simple weapons"],
		skillCount: 2, skillChoices: ["arcana", "deception", "history", "intimidation", "investigation", "nature", "religion"],
		casterType: "pact", castingAbility: "cha",
		cantripsKnown: 2, spellsKnown: 2, maxSpellLevel: 1,
	},
	Wizard: {
		source: "PHB", hitDie: "d6",
		saves: ["int", "wis"],
		armorProfs: [],
		weaponProfs: ["Daggers", "Darts", "Slings", "Quarterstaffs", "Light crossbows"],
		skillCount: 2, skillChoices: ["arcana", "history", "insight", "investigation", "medicine", "religion"],
		casterType: "full", castingAbility: "int",
		cantripsKnown: 3, spellsKnown: 6, maxSpellLevel: 1, // Wizard starts with 6 in spellbook
	},
};
