...
describe("R31 integrated repro — Doubleshot surfacing → consume chain (#14b → #14)", () => {
	...
	const mkAutoLongbow = () => ({
		id: "auto_longbow", name: "Longbow", isMelee: false, abilityMod: "dex",
		range: "150/600", damage: "1d8", damageType: "Piercing",
		properties: ["A|XPHB", "H|XPHB", "2H|XPHB"], isAutoGenerated: true,
	});
