...
describeCharacter({
	...
	featuresMatrix: [
		...
		{
			level: 3,
			name: /primal knowledge/i,
			kind: "passive",
			effects: [{
				kind: "stateTransaction",
				steps: [
					{method: "setAbilityBase", args: ["str", 18]},
					{method: "setAbilityBase", args: ["wis", 10]},
					{method: "getSkillAbility", args: ["perception"], expect: [{exact: "wis"}]},
					{method: "getSkillMod", args: ["perception"], saveAs: "before"},
					{method: "activateState", args: ["rage"]},
					{method: "getSkillAbility", args: ["perception"], expect: [{exact: "str"}]},
					{method: "getSkillModWithAbility", args: ["perception", "str"], saveAs: "strengthCheck"},
					{method: "getSkillMod", args: ["perception"], expect: [{equalsRef: "strengthCheck"}]},
					{method: "getSkillBreakdown", args: ["perception"], expect: [
						{path: "ability", exact: "str"},
						{path: "components", contains: "Primal Knowledge"},
					]},
					{method: "deactivateState", args: ["rage"]},
					{method: "getSkillMod", args: ["perception"], expect: [{equalsRef: "before"}]},
				],
			}],
		},
