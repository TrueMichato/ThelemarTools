...
const REANIMATOR_SPELL_GRANTS = [
	{level: 3, name: "False Life", source: "XPHB"},
	{level: 3, name: "Spare the Dying", source: "XPHB"},
	{level: 3, name: "Witch Bolt", source: "XPHB"},
	{level: 5, name: "Blindness/Deafness", source: "XPHB"},
	{level: 5, name: "Enhance Ability", source: "XPHB"},
	{level: 9, name: "Animate Dead", source: "XPHB"},
	{level: 9, name: "Lightning Bolt", source: "XPHB"},
	{level: 13, name: "Blight", source: "XPHB"},
	{level: 13, name: "Death Ward", source: "XPHB"},
	{level: 17, name: "Antilife Shell", source: "XPHB"},
	{level: 17, name: "Raise Dead", source: "XPHB"},
] as const;
	...
	},
	{
		...
		effects: [
			{kind: "rhwReanimatorProbe", probe: "roundTripRespec"},
			{
				...
				subclassSource: "RHW",
				featureUids: [
					{level: 3, uid: "Reanimator Spells|Artificer|EFA|Reanimator|RHW|3|RHW"},
					{level: 3, uid: "Reanimator's Skill Set|Artificer|EFA|Reanimator|RHW|3|RHW"},
					{level: 3, uid: "Reanimated Companion|Artificer|EFA|Reanimator|RHW|3|RHW"},
					{level: 5, uid: "Strange Modifications|Artificer|EFA|Reanimator|RHW|5|RHW"},
					{level: 9, uid: "Improved Reanimation|Artificer|EFA|Reanimator|RHW|9|RHW"},
					{level: 9, uid: "Macabre Modifications|Artificer|EFA|Reanimator|RHW|9|RHW"},
					{level: 15, uid: "Refined Reanimation|Artificer|EFA|Reanimator|RHW|15|RHW"},
				],
