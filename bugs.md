...
### Builder
[] the cantrip selector looks out of date with the rest of the sheet, and hover in it appears behind it.
[] In custom backgrounds, rolling down after tools to choose a language in the choose either box does not work, and the language options are not visible.
