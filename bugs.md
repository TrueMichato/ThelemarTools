...
[X] In the builder and multiclassing, the Illrigger class appears both from the Illrigger source and the TGTT source, but only the TGTT version should be available for selection.
