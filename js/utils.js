...
globalThis.VERSION_NUMBER = /* 5ETOOLS_VERSION__OPEN */"2.32.0"/* 5ETOOLS_VERSION__CLOSE */;
...
UrlUtil.URL_TO_HASH_BUILDER[UrlUtil.PG_ENCOUNTERGEN] = (it) => UrlUtil.encodeArrayForHash(it.name, it.source, `${it.minlvl ?? 0}-${it.maxlvl ?? 0}-${it.caption || ""}`);
