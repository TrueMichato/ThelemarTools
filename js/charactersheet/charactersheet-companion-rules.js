	...
	return {
		...
		operations: {
			...
			arcaneConduitDamageRider: {
				status: selected.has("arcaneConduit") ? "executable" : "unavailable",
			},
			bloatedPush: {status: selected.has("bloated") ? "executableManualResolution" : "unavailable"},
			gauntFearAura: {status: selected.has("gaunt") ? "executableManualResolution" : "unavailable"},
			moistAcidRetaliation: {status: selected.has("moist") ? "executableManualResolution" : "unavailable"},
		},
	};
}
