...
function createTableEffects (entries = []) {
	const automatic = {
		...
		5: {
			...
			effects: [{type: "note", value: "You glow as if affected by the Light cantrip."}],
			duration: "spell duration",
		},
		...
		22: {
			...
			effects: [{type: "note", value: "You are levitated 20 feet above the ground."}],
		...
		25: {
			...
			effects: [{type: "sense", senseType: "xray", value: 60}],
			duration: "1d6 rounds",
		},
		27: {
			scope: "self",
			effectType: "activeState",
			stateId: "gamblerSilence",
			stateName: "Gambler's Folly: Silence",
			effects: [{type: "note", value: "Silence, 15-foot radius, centers on you."}],
			duration: "spell duration",
		},
