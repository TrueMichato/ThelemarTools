...
HUB_INVITE_TOKEN_SECRET="$(openssl rand -hex 32)"
...
HUB_INVITE_TOKEN_SECRET=$HUB_INVITE_TOKEN_SECRET
HUB_INVITE_TOKEN_PREVIOUS_SECRETS=$HUB_INVITE_TOKEN_PREVIOUS_SECRETS
...
unset HUB_COOKIE_SECRET HUB_CSRF_SECRET HUB_INVITE_TOKEN_SECRET HUB_INVITE_TOKEN_PREVIOUS_SECRETS HUB_METRICS_TOKEN HUB_BACKUP_ENCRYPTION_KEY HUB_VCS_REF
```
