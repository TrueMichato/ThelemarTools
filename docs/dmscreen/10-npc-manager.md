...
- The pure d20 helper accepts optional named advantage/disadvantage inputs for the separate Encounter Workspace. With none provided by the NPC Manager, its condition, manual-choice, auto-fail, attack, and initiative behavior is unchanged; encounter-only flat bonuses and selected-target filtering live outside the NPC Manager.
